...
function downloadXLS(){
    ...
    btn.addEventListener("click", function(){
        ...
        var tab_text = "<table border='2px' font='20px'><tr>";
        var textRange;
        var j = 0;
        tab = document.getElementById('tbl_exporttable_to_xls'); // id of table
        ...
        if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) // If Internet Explorer
        {
            ...
            txtArea1.focus();
            sa = txtArea1.document.execCommand("SaveAs", true, "Anmeldungen.xls");
