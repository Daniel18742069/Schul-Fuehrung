                            ...
                            <div class="accordion-body js-accordion-body">
                                <div class="accordion-body__contents">
                                    <form class="form_buchung" method="POST" action="index.php?aktion=anmelden">
                                        ...
                                        <input type="text" name="vorname" value="" onblur="formAusgefuellt(this)" disabled="<?= ($anzahl_teilnehmer[$fuehrung->getId()] === $fuehrung->getKapazitaet()) ? 'disabled' : ''; ?>" /><br />
                                        <label for="nachname">Nachname:</label>
                                        <input type="text" name="nachname" value="" onblur="formAusgefuellt(this)" disabled="<?= ($anzahl_teilnehmer[$fuehrung->getId()] === $fuehrung->getKapazitaet()) ? 'disabled' : ''; ?>" /><br />
                                        <label for="telefon">Telefon:</label>
                                        <input type="telefon" name="telefon" value="" onblur="formAusgefuellt(this)" disabled="<?= ($anzahl_teilnehmer[$fuehrung->getId()] === $fuehrung->getKapazitaet()) ? 'disabled' : ''; ?>" /><br />
                                        <label for="email">E-Mail:</label>
                                        <input type="email" name="email" value="" onblur="formAusgefuellt(this)" disabled="<?= ($anzahl_teilnehmer[$fuehrung->getId()] === $fuehrung->getKapazitaet()) ? 'disabled' : ''; ?>" /><br />
                                        <label for="anzahl">Personen:</label>
                                        <input type="number" name="anzahl" value="1" max="<?= $fuehrung->getKapazitaet() - $anzahlTeilnehmer; ?>" min="1" placeholder="1" onblur="formAusgefuellt(this)" disabled="<?= ($anzahl_teilnehmer[$fuehrung->getId()] === $fuehrung->getKapazitaet()) ? 'disabled' : ''; ?>" />
