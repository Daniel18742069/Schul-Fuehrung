...
<head>
    ...
    <link rel="mask-icon" type="image/x-icon" href="/Schul-Fuehrung/img/favicon.png" color="#111" /> <!-- für Safari soweit ich weiss-->
...
<body>
    ...
    <?php require_once '/Schul-Fuehrung/snippets/captcha.sp.php'; ?>
    <?php require_once '/Schul-Fuehrung/snippets/loading_screen.sp.php'; ?>
</body>
