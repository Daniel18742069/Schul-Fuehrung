...
<head>
    ...
    <link rel="stylesheet" href="openday.tschaufer.it/view/be_CSS/style_fuehrungen_editieren.css" />
    <script type="text/javascript" src="openday.tschaufer.it/model/JS/script.js"></script>
...
<body>
    ...
    <section id="wrapper-be">
        ...
        <div class="wrapper-fe_startseite">
            ...
            <form action="openday.tschaufer.it/FuehrungEditieren/<?= $offenerTag->getID() ?>" method="post">
                ...
                <input type="button" class="zurueck-admin-panel" onclick="location.href='openday.tschaufer.it/AlleOpenDay'" value="zurück"/>
